...
$('.navbar-mobile').click(function() {
	$('.menus').slideToggle();
	$('.navbar-mobile').toggleClass('mobile-active');
})
// --------------------
...
// --------------------
// ---------- 클릭해서 유튜브 헬퍼 쇼케이스 페이지로 이동 시작 ----------
const showcase_youtube = document.getElementById("showcase-youtube");
function movetoyoutubehelper_showcase () {
	window.open("https://www.youtube.com/watch?v=BxXAmUqmynY")
}
showcase_youtube.addEventListener("click", movetoyoutubehelper_showcase);
// --------------------
// ---------- 이메일 클립보드 카피 시작 ----------
